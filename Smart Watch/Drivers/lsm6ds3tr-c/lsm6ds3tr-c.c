...
void lsm6ds3tr_c_tap_cfg(I2C_HandleTypeDef *hi2c){
	...
	HAL_I2C_Mem_Write(hi2c, LSM6DS3_ADDR, TAP_CFG, I2C_MEMADD_SIZE_8BIT, 0x8E, 1, HAL_MAX_DELAY);

	HAL_I2C_Mem_Write(hi2c, LSM6DS3_ADDR, TAP_THS_6D, I2C_MEMADD_SIZE_8BIT, 0x85, 1, HAL_MAX_DELAY);

	HAL_I2C_Mem_Write(hi2c, LSM6DS3_ADDR, INT_DUR2, I2C_MEMADD_SIZE_8BIT, 0x7F, 1, HAL_MAX_DELAY);

	HAL_I2C_Mem_Write(hi2c, LSM6DS3_ADDR, WAKE_UP_THS, I2C_MEMADD_SIZE_8BIT, 0x80, 1, HAL_MAX_DELAY);

	HAL_I2C_Mem_Write(hi2c, LSM6DS3_ADDR, MD1_CFG, I2C_MEMADD_SIZE_8BIT, 0x08, 1, HAL_MAX_DELAY);
}
